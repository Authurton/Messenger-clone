  ...
  return (
    <div className="App">
      ...
      <FormControl className="app__formControl" >
        ...
        {/* <Button 
          type="submit" variant="contained" color="primary" 
          disabled={!input} onClick={sendMessage} >Send message
        </Button> */}
      </FormControl>
      </form>
